...
#define SOCKET_CHECK_TIMEOUT_MS 1000  /* used for nonblock socket check interval */
...
typedef struct Port
{
   ...
   */
	...
	bool DoingCopyOut;		/* in old-protocol COPY OUT processing */
} Port;
...
extern bool be_tls_read_pending(Port *port);
